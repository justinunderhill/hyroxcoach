...
export default async function JoinTeamPage({
  ...
  return (
    <main className="min-h-screen px-5 py-8 sm:py-12">
      <section className="mx-auto max-w-lg rounded-[2rem] border border-white/70 bg-white p-7 shadow-[0_30px_90px_rgba(26,44,34,0.13)] sm:p-10">
        <p className="font-mono text-xs font-semibold uppercase tracking-[0.2em] text-[#567118]">
          Team invite
        </p>
        <h1 className="mt-3 text-3xl font-semibold tracking-[-0.045em] text-[#15221b]">
        ...
        <Link className="mt-6 inline-block text-xs font-semibold text-stone-500" href="/dashboard">
